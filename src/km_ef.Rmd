...
cifunc(
  ...
  yposplus = c(-0.016, 0, 0.006) # ref, mref, pef
)
```
...
cifunc(
  ...
  yposplus = c(0, -0.006, 0) # ref, mref, pef
)
```
...
cifunc(
  ...
  yposplus = c(0.015, -0.015, 0) # ref, mref, pef
)
```
...
mcffunc(
  ...
  yposplus = c(-0.03, 0, 0.03) # ref, mref, pef
)
```
...
cifunc(
  ...
  yposplus = c(0, 0.025, -0.015) # ref, mref, pef
)
```
...
kmfunc(
  ...
  yposplus = c(-0.01, 0.01, 0) # ref, mref, pef
)
```
...
cifunc(
  ...
  yposplus = c(0, 0, 0.011) # ref, mref, pef
)
```
